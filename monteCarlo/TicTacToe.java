...
public class TicTacToe  {
    ...
    //*Fields
    //**********************************************************/
    Board board; // passes user selection choices to the game board
    JPanel panel; // facilitates the transportation of main panel
    TicTacToe tacToe;// saves game info, to be used by board 
    ...
    TicTacToe(){
        size = 3; // default board size is three
        board = new Board(size); // create a board with this default size        
    ...
    /*
     * Sets the TicTacToe object to the parameter value. Used to save 
    ...
    public void createPanel(){
        ...
        // a comboBox which decides the possible board size. Options are 3, 4, and 5.
        final DefaultComboBoxModel<Integer> boardSize = new DefaultComboBoxModel<>();        
        boardSize.addElement(3);
        boardSize.addElement(4);
        boardSize.addElement(5);
        ...
        //**********************************************************/
        // a panel that holds the label info for the board size options
        JPanel labelAPanel = new JPanel(new FlowLayout(FlowLayout.LEFT));
        JLabel labelA = new JLabel("Board size: ");
        labelA.setFont(new Font("Curier", Font.BOLD, fontSize));
        labelAPanel.add(labelA);
        ...
        //**********************************************************/
        // a panel that holds the board size options info
        JPanel cBoxAPanel = new JPanel(new FlowLayout(FlowLayout.RIGHT));
        JComboBox<Integer> comboBoxA = new JComboBox<>(boardSize);
        comboBoxA.setFont(new Font("Courier", Font.BOLD, fontSize));
        cBoxAPanel.add(comboBoxA);
        ...
        JSplitPane jspA = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, true, labelAPanel, cBoxAPanel);
        jspA.setResizeWeight(0.27);        
        ...
        comboBoxA.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent event) {
                ...
                board.setCompPlayStatus(compPlayStatus);
                board.setCompMovesFirst(compMovesFirst);
            }
        });        
    ...
    public static void main(String[] args) {
        ...
        TicTacToe tacToe = new TicTacToe(); // create a tic tac toe object
        tacToe.board.setTicTacToe(tacToe); // pass it to the board as a reference
        tacToe.buildFrame(); // build the game frame
