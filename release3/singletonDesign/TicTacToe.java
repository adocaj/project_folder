...
public class TicTacToe  {
    ...
    // Singleton pattern initiation
    private static TicTacToe tacToeObject = null;

    public static TicTacToe getTicTacToeInstance(){
        if (tacToeObject == null) {
            tacToeObject = new TicTacToe();
        }
        return tacToeObject;
    } 
    ...
    public static void main(String[] args) {
        ...
        TicTacToe tacToe = TicTacToe.getTicTacToeInstance();
